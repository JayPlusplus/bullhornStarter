...
public class ProfileServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session.getAttribute("bhuser")==null){
		 ...
		 */			
		Bhuser loggedInUser = (Bhuser) session.getAttribute("bhuser");//<-- here we are casting to a User object
		...
		System.out.printf("this is loggedInUser %s%n", loggedInUser);
		System.out.printf("this is profileUser %s%n", profileUser);
		...
		if (loggedInUser.getBhuserid()==profileUser.getBhuserid()){
			...
			request.setAttribute("bhuserid", profileUser.getBhuserid());
